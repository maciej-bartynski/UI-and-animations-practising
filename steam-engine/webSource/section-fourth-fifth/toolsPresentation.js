...
function cogtest() {
    ...
    let theSection = document.querySelector('#sectionToolsAndMaterials');
    theSection.addEventListener('mouseover', function(){
        btn.classList.add('beforeIsPressed');
    });
    theSection.addEventListener('mouseout', function(){
        btn.classList.remove('beforeIsPressed');
    });
    btn.addEventListener('click', function () {
        animateMachineStart();
        let isExplorer = document.querySelector('svg.turning-on-cog');
